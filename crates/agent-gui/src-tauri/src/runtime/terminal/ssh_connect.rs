...
pub(crate) struct OzawaAgentSshClient {
    pub(crate) host: String,
    pub(crate) port: u16,
    pub(crate) captured_host_key: Arc<tokio::sync::Mutex<Option<CapturedHostKey>>>,
}

impl client::Handler for OzawaAgentSshClient {
...
) -> Result<client::Handle<OzawaAgentSshClient>, String> {
    let ssh_client = OzawaAgentSshClient {
