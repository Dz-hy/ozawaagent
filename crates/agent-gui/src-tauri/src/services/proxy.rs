...
const PROXY_PREFIX: &str = "x-ozawaagent-";
const PROXY_TOKEN_HEADER: &str = "x-ozawaagent-proxy-token";
const REFERER: &str = "referer";
const TE: &str = "te";
const TRAILER: &str = "trailer";
const TRANSFER_ENCODING: &str = "transfer-encoding";
const UPGRADE: &str = "upgrade";
const UPSTREAM_ORIGIN_HEADER: &str = "x-ozawaagent-upstream-origin";
const UPSTREAM_USER_AGENT_HEADER: &str = "x-ozawaagent-upstream-user-agent";
const UPSTREAM_CONTENT_TYPE_HEADER: &str = "x-ozawaagent-upstream-content-type";
const USE_SYSTEM_PROXY_HEADER: &str = "x-ozawaagent-use-system-proxy";
const DEFAULT_ALLOW_HEADERS: &str = "authorization,content-type,x-api-key,x-goog-api-key,anthropic-version,x-ozawaagent-upstream-origin,x-ozawaagent-upstream-user-agent,x-ozawaagent-upstream-content-type,x-ozawaagent-proxy-token,x-ozawaagent-use-system-proxy";
...
mod tests {
    ...
    fn echoes_requested_preflight_headers() {
        ...
        headers.insert(
            ...
            HeaderValue::from_static("authorization,x-api-key,x-ozawaagent-proxy-token"),
        );
