fn main() {
    ...
    println!("cargo:rerun-if-env-changed=OZAWAAGENT_APP_VERSION");

    let app_version = std::env::var("OZAWAAGENT_APP_VERSION")
        .ok()
    ...
    println!("cargo:rustc-env=OZAWAAGENT_APP_VERSION={app_version}");
