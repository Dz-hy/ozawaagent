...
export const translations: Record<Locale, Record<string, string>> = {
  "zh-CN": {
    ...
    "governance.subtitle": "全部可执行资产的来源、风险与启用状态一览（只读）",
    "governance.navShort": "治理中心",
    "governance.navTitle": "执行治理中心",
    "governance.refresh": "刷新",
    "governance.loading": "正在加载资产清单…",
    "governance.searchPlaceholder": "搜索名称、ID 或描述…",
    "governance.total": "共 {count} 项",
    "governance.filterCategory": "类型",
    "governance.filterSource": "来源",
    "governance.filterRisk": "风险",
    "governance.readOnlyNote": "只读视图：数据由 GenericAgent 运行时提供，本页不修改任何资产。",
    "governance.empty": "没有匹配的资产，调整筛选条件后重试。",
    "governance.noRisk": "无风险标签",
    "governance.na": "—",
    "governance.enabled": "已启用",
    "governance.disabled": "已禁用",
    "governance.invalid": "无效",
    "governance.category.command": "命令",
    "governance.category.command_pack": "命令包",
    "governance.category.skill": "技能",
    "governance.category.connector": "连接器",
    "governance.category.hook": "钩子",
    "governance.category.automation": "自动化",
    "governance.category.confirmation": "确认",
    "governance.source.builtin": "内置",
    "governance.source.user": "用户创建",
    "governance.source.third_party": "第三方",
    "governance.source.unknown": "未知来源",
    "governance.risk.shell": "Shell",
    "governance.risk.write": "写文件",
    "governance.risk.delete": "删除",
    "governance.risk.network": "网络",
    "governance.risk.credentials": "凭据",
    "governance.risk.scheduled": "定时",
    "governance.tabInventory": "资产清单",
    "governance.tabHistory": "审计历史",
    "governance.auditFilterOutcome": "结果",
    "governance.auditFilterTime": "时间范围",
    "governance.auditOutcome.ok": "成功",
    "governance.auditOutcome.error": "失败",
    "governance.auditTime.all": "全部时间",
    "governance.auditTime.today": "今天",
    "governance.auditTime.week": "近 7 天",
    "governance.auditTime.month": "近 30 天",
    "governance.auditEmpty": "暂无执行记录",
    "governance.auditNote":
      "执行记录来自 adapter 直面的执行入口（命令执行与 MCP 调用），自动化运行来自 GA 调度器历史，均为本地只读记录。",
    "governance.auditViewAsset": "查看资产",
    "governance.auditDisable": "禁用",
    "governance.auditDisabled": "已禁用",
    "governance.auditDisableFailed": "禁用失败",
    "governance.tabPolicy": "策略",
    "governance.category.policy": "策略",
    "governance.policy.saveFailed": "策略更新失败",
    "governance.policy.allowlistTitle": "出站 HTTP 域名允许列表",
    "governance.policy.allowlistNote":
      "列表非空时，http 连接器的任何协议调用只允许访问列表内域名，列表外请求被拒绝并记入审计；保存需人工确认。",
    "governance.policy.allowlistPlaceholder": "每行一个域名，例如 example.com",
    "governance.policy.allowlistSave": "保存允许列表",
    "governance.policy.entriesTitle": "资产启用/禁用条目",
    "governance.policy.entriesNote":
      "策略只覆盖命令与连接器两类可执行资产：全局禁用立即生效；项目级条目仅约束绑定对应项目的会话。变更均写入审计。",
    "governance.policy.entriesEmpty": "暂无策略条目",
    "governance.policy.scopeGlobal": "全局",
    "governance.policy.scopeProject": "项目",
    "governance.policy.entryRemove": "移除",
    "governance.policy.entryCategory": "类型",
    "governance.policy.entryTarget": "目标",
    "governance.policy.entryTargetPlaceholder": "命令 id 或连接器名",
    "governance.policy.entryScope": "作用范围",
    "governance.policy.scope.global": "全局",
    "governance.policy.scope.project": "项目",
    "governance.policy.entryProjectId": "项目 ID",
    "governance.policy.entryEnabled": "状态",
    "governance.policy.state.enabled": "启用",
    "governance.policy.state.disabled": "禁用",
    "governance.policy.entryAdd": "添加",
    "governance.policy.confirmSaveTitle": "保存策略变更？",
    "governance.policy.confirmSaveDescription": "新的出站允许列表立即生效并写入审计。",
    "governance.policy.confirmSave": "保存",
    "governance.policy.confirmRemoveTitle": "移除策略条目？",
    "governance.policy.confirmRemoveDescription": "将恢复 {target} 的默认启用状态。",
    "governance.policy.confirmRemove": "移除",
    "governance.policy.confirmAddTitle": "添加策略条目？",
    "governance.policy.confirmAddDescription": "{target} 的策略变更立即生效并写入审计。",
    "governance.policy.confirmAdd": "添加",
    "governance.policy.confirmToggleTitle": "切换资产启用状态？",
    "governance.policy.confirmToggleDisableDescription":
      "将全局禁用 {target}，立即生效并写入审计。",
    "governance.policy.confirmToggleEnableDescription": "将恢复 {target} 的默认启用状态。",
    "governance.policy.toggleDisable": "禁用",
    "governance.policy.toggleEnable": "解除禁用",
    "governance.confirm.title": "高危操作确认",
    "governance.confirm.description":
      "该能力首次执行（本次会话），需您批准后才执行；批准后本次会话内不再重复询问。",
    "governance.confirm.approve": "批准执行",
    "governance.confirm.deny": "拒绝",
    "governance.confirm.close": "关闭",
    "governance.confirm.deniedNotice": "该能力此前已被拒绝；您可以重新批准后执行。",
  ...
  "en-US": {
    ...
    "governance.subtitle":
      "Source, risk, scope, and enabled state of every executable asset (read-only)",
    "governance.navShort": "Governance",
    "governance.navTitle": "Execution Governance Center",
    "governance.refresh": "Refresh",
    "governance.loading": "Loading asset inventory…",
    "governance.searchPlaceholder": "Search by name, ID, or description…",
    "governance.total": "{count} total",
    "governance.filterCategory": "Category",
    "governance.filterSource": "Source",
    "governance.filterRisk": "Risk",
    "governance.readOnlyNote":
      "Read-only view: data comes from the GenericAgent runtime; this page never mutates assets.",
    "governance.empty": "No assets match the current filters.",
    "governance.noRisk": "No risk labels",
    "governance.na": "—",
    "governance.enabled": "Enabled",
    "governance.disabled": "Disabled",
    "governance.invalid": "Invalid",
    "governance.category.command": "Command",
    "governance.category.command_pack": "Command pack",
    "governance.category.skill": "Skill",
    "governance.category.connector": "Connector",
    "governance.category.hook": "Hook",
    "governance.category.automation": "Automation",
    "governance.category.confirmation": "Confirmation",
    "governance.source.builtin": "Built-in",
    "governance.source.user": "User-created",
    "governance.source.third_party": "Third-party",
    "governance.source.unknown": "Unknown",
    "governance.risk.shell": "Shell",
    "governance.risk.write": "Write",
    "governance.risk.delete": "Delete",
    "governance.risk.network": "Network",
    "governance.risk.credentials": "Credentials",
    "governance.risk.scheduled": "Scheduled",
    "governance.tabInventory": "Inventory",
    "governance.tabHistory": "Audit history",
    "governance.auditFilterOutcome": "Outcome",
    "governance.auditFilterTime": "Time range",
    "governance.auditOutcome.ok": "OK",
    "governance.auditOutcome.error": "Failed",
    "governance.auditTime.all": "All time",
    "governance.auditTime.today": "Today",
    "governance.auditTime.week": "Last 7 days",
    "governance.auditTime.month": "Last 30 days",
    "governance.auditEmpty": "No execution records yet",
    "governance.auditNote":
      "Execution records cover adapter-facing entry points only (command execution and MCP calls); automation runs come from the GA scheduler history. All records are local and read-only.",
    "governance.auditViewAsset": "View asset",
    "governance.auditDisable": "Disable",
    "governance.auditDisabled": "Disabled",
    "governance.auditDisableFailed": "Failed to disable",
    "governance.tabPolicy": "Policy",
    "governance.category.policy": "Policy",
    "governance.policy.saveFailed": "Failed to update policy",
    "governance.policy.allowlistTitle": "Outbound HTTP domain allowlist",
    "governance.policy.allowlistNote":
      "When non-empty, http connector protocol calls are restricted to listed domains; requests outside the list are rejected and recorded in the audit log. Saving requires confirmation.",
    "governance.policy.allowlistPlaceholder": "One domain per line, e.g. example.com",
    "governance.policy.allowlistSave": "Save allowlist",
    "governance.policy.entriesTitle": "Asset enable/disable entries",
    "governance.policy.entriesNote":
      "Policy covers executable commands and connectors only: global disables take effect immediately; project-scoped entries constrain only sessions bound to that project. Every change is written to the audit log.",
    "governance.policy.entriesEmpty": "No policy entries",
    "governance.policy.scopeGlobal": "Global",
    "governance.policy.scopeProject": "Project",
    "governance.policy.entryRemove": "Remove",
    "governance.policy.entryCategory": "Category",
    "governance.policy.entryTarget": "Target",
    "governance.policy.entryTargetPlaceholder": "command id or connector name",
    "governance.policy.entryScope": "Scope",
    "governance.policy.scope.global": "Global",
    "governance.policy.scope.project": "Project",
    "governance.policy.entryProjectId": "Project ID",
    "governance.policy.entryEnabled": "State",
    "governance.policy.state.enabled": "Enabled",
    "governance.policy.state.disabled": "Disabled",
    "governance.policy.entryAdd": "Add",
    "governance.policy.confirmSaveTitle": "Save policy changes?",
    "governance.policy.confirmSaveDescription":
      "The new outbound allowlist takes effect immediately and is recorded in the audit log.",
    "governance.policy.confirmSave": "Save",
    "governance.policy.confirmRemoveTitle": "Remove policy entry?",
    "governance.policy.confirmRemoveDescription":
      "This restores the default enabled state of {target}.",
    "governance.policy.confirmRemove": "Remove",
    "governance.policy.confirmAddTitle": "Add policy entry?",
    "governance.policy.confirmAddDescription":
      "Policy changes for {target} take effect immediately and are recorded in the audit log.",
    "governance.policy.confirmAdd": "Add",
    "governance.policy.confirmToggleTitle": "Toggle asset enablement?",
    "governance.policy.confirmToggleDisableDescription":
      "This globally disables {target}, effective immediately and recorded in the audit log.",
    "governance.policy.confirmToggleEnableDescription":
      "This restores the default enabled state of {target}.",
    "governance.policy.toggleDisable": "Disable",
    "governance.policy.toggleEnable": "Re-enable",
    "governance.confirm.title": "High-risk execution confirmation",
    "governance.confirm.description":
      "This capability is executing for the first time this session and needs your approval. Approved grants last for this session.",
    "governance.confirm.approve": "Approve & run",
    "governance.confirm.deny": "Deny",
    "governance.confirm.close": "Close",
    "governance.confirm.deniedNotice":
      "This capability was denied before; you can approve it now to proceed.",
