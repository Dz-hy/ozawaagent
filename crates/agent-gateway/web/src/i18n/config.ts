...
export const translations: Record<Locale, Record<string, string>> = {
  "zh-CN": {
    ...
    "settings.systemProxyDesc":
      "生效范围：桌面端本地命令环境变量（Bash / 后台任务 / 自动化脚本）、勾选“使用应用代理”的供应商请求、Hook / Cron HTTP 任务、聊天图片加载与技能下载。",
  ...
  "en-US": {
    ...
    "settings.systemProxyDesc":
      "Applies to: local command environment on the desktop (Bash / background tasks / automation scripts), providers with “Use app proxy” checked, Hook / Cron HTTP tasks, chat image loading, and skill downloads.",
    "settings.systemProxyInvalid":
